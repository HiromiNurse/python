...
def main():
    ...
    print("# Power = True, Channel = 0, Volume = 0")

    tv_1.channel_up()
    tv_1.channel_up()
    tv_1.volume_up()
    print(tv_1)             # Power = True, Channel = 2, Volume = 1
    print("# Power = True, Channel = 2, Volume = 1")
    ...
    print("# Power = True, Channel = 1, Volume = 0")

    tv_1.power()
    tv_1.volume_up()
    tv_1.channel_down()
    print(tv_1)             # Power = False, Channel = 1, Volume = 0
    print("# Power = False, Channel = 1, Volume = 0")
    ...
    print("# Power = True, Channel = 3, Volume = 2")
    ...
    print("# Power = True, Channel = 1, Volume = 1, Television: 2")

    # Muting effect
    tv_1.mute()
    print(tv_1)             # Power = True, Channel = 3, Volume = 0
    print("# Power = True, Channel = 3, Volume = 0")
    tv_1.volume_down()
    print(tv_1)             # Power = True, Channel = 3, Volume = 1
    print("# Power = True, Channel = 3, Volume = 1")
    tv_1.mute()
    print(tv_1)             # Power = True, Channel = 3, Volume = 0
    print("# Power = True, Channel = 3, Volume = 0")
    tv_1.volume_up()
    ...
    print("# Power = False, Channel = 3, Volume = 2")
